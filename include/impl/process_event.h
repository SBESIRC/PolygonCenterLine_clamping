		...
		*/
		...
		if (event.type == EventType::TRIANGLE) {
			...
			if (event_a->prev != event_b->next) {
				...
				/* if(seg0.source()��seg1.target()����){ ֱ������ }
else if(l0 < l1){ ��seg1.target()��λ�ý��㣬�и�seg0������ }
else if(l0 > l1){ ��seg0.source()��λ�ý��㣬�и�seg1������ }*/
			}
			else {
			...
			if (event_a->next != event_b->prev) {
				...
				/* if(seg0.source()��seg1.target()����){ ֱ������ }
if(r0 < r1){ ��seg0.target()��λ�ý��㣬�и�seg1������ }
else if(r0 > r1){ ��seg1.source()��λ�ý��㣬�и�seg0������ } */
			}
			else {
