...
struct CenterLineSolver{
	...
	void CutHalfEdge(EdgeData *base, EdgeData *edge, bool type, Point_2 location, std::vector<PointData*> &point_pool, std::vector<EdgeData*> &edge_pool);

	void CutHalfPoint(EdgeData *prev, EdgeData *next, Point_2 location, std::vector<PointData*> &point_pool, std::vector<EdgeData*> &edge_pool);
	void CutEdge(EdgeData *base, EdgeData *prev, EdgeData *next, Point_2 location, std::vector<PointData*> &point_pool, std::vector<EdgeData*> &edge_pool);
	void operator () (const Poly_with_holes& polygon);	CenterLineSolver(){
		is_debugging = false;
	}
};
